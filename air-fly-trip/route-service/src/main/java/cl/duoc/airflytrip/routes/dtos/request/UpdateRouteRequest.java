...
@Getter
@Setter
@Schema(description = "Datos requeridos para actualizar completamente una ruta existente.")
public class UpdateRouteRequest {
    ...
    @Schema(description = "Distancia total de la ruta en kilometros.", example = "14.2")
    private BigDecimal distanceKm;

    @NotNull(message = "Estimated minutes is required")
    @Min(value = 1, message = "Estimated minutes must be greater than 0")
    @Schema(description = "Tiempo estimado de viaje en minutos.", example = "40")
    private Integer estimatedMinutes;

    @Schema(description = "Indica si la ruta permanece activa.", example = "true")
