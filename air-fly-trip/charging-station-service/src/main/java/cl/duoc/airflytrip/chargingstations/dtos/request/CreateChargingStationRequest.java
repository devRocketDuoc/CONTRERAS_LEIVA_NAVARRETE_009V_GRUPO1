...
@Getter
@Setter
@Schema(description = "Datos requeridos para crear una nueva estacion de carga en el sistema.")
public class CreateChargingStationRequest {
    ...
    @Schema(description = "Estado operativo inicial de la estacion de carga.", example = "AVAILABLE")
